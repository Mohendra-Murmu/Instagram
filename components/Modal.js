...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        //upload the image to fierbase starage with post id
        //get a download url from fierbase storage and update to original opst with image
        ...
        console.log("Nwe Doc added with Id", docRef.id);
...
overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-full sm:p-6
' >
                            <div>
                                {selectedFile ? (
                                    <div className='w-80 h-50 z-50'>
...
px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none first-letter:
focus:ring focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed
